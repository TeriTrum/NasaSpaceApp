...
(function(){
  ...
  P.initMap = function(){
    const boundsNA = L.latLngBounds([[5, -168], [83, -52]]);
    const map = L.map('map', { worldCopyJump:true, maxBounds: boundsNA.pad(0.05), maxBoundsViscosity: 1.0 });
    ...
    map.fitBounds(boundsNA, { padding:[20,20] });
    P.map = map;
